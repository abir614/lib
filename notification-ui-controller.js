// Notification Settings UI Controller
const NotificationUI = {
    ...
    init() {
        // Get elements
        this.elements.settings = document.getElementById('notificationSettings');
        this.elements.toggle = document.getElementById('notificationToggle');
        this.elements.badge = document.getElementById('notificationBadge');
        this.elements.status = document.getElementById('notificationStatus');
        this.elements.statusText = document.getElementById('statusText');
        this.elements.enableBtn = document.getElementById('enableNotifications');
        this.elements.disableBtn = document.getElementById('disableNotifications');
        this.elements.testBtn = document.getElementById('testNotification');
        this.elements.closeBtn = document.getElementById('closeSettings');
    ...
    async enableNotifications() {
        ...
        if (result.success) {
            UIManager?.showNotification('Notifications enabled!', 'info');
        } else {
            UIManager?.showNotification(result.error || 'Failed to enable notifications', 'error');
        }
    ...
    async disableNotifications() {
        ...
        if (result.success) {
            UIManager?.showNotification('Notifications disabled', 'info');
        } else {
            UIManager?.showNotification(result.error || 'Failed to disable notifications', 'error');
        }
    ...
    async sendTestNotification() {
        ...
        if (result.success) {
            UIManager?.showNotification('Test notification sent!', 'info');
        } else {
            UIManager?.showNotification(result.error || 'Failed to send test', 'error');
        }
